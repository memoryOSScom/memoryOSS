...
| release-smoke workflow | healthy | live run `23015980828` on the shared builder path succeeded | smoke and release now share one reusable build workflow |
...
| live release-smoke workflow | pass | GitHub Actions run `23015980828` proved the shared-builder refactor remotely |
